...
app.use((req, res, next) => {
  ...
  res.header(
    ...
    [
      ...
      "connect-src 'self' https://api.brevo.com https://conversations.brevo.com https://sibtrackandtrace.co https://chat.brevo.com https://ws.brevo.com https://analytics.brevo.com https://www.google-analytics.com https://sibautomation.com https://in-automate.brevo.com",
      "object-src 'none'",
      "base-uri 'self'",
    ].join("; "),
  );
