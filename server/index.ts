...
app.use((req, res, next) => {
  ...
  res.header('Content-Security-Policy', [
      "default-src 'self'", "script-src 'self', 'unsafe-inline', 'unsafe-eval', blob: https://replit.com https://cdn.brevo.com https://js.brevo.com <script src=\"https://cdn.brevo.com/js/sdk-loader.js\" async></script>",
