...
app.use((req, res, next) => {
  ...
  res.header(
    ...
    [
      ...
      "frame-src 'self' https://*.brevo.com https://cdn.by.wonderpush.com",
      "connect-src 'self' https://*.brevo.com https://sibautomation.com https://cdn.by.wonderpush.com https://*.wonderpush.com",
      "object-src 'none'",
      "base-uri 'self'",
    ].join("; "),
  );
