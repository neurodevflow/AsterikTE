    ...
    <div className="pt-16 bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-charcoal max-w-3xl mx-auto">
              Comprehensive digital commerce solutions designed to drive growth and enhance customer experiences.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 border border-light-grey">
              <h3 className="text-2xl font-bold text-navy-blue mb-4">E-commerce Platforms</h3>
              <p className="text-charcoal mb-6">
                Custom e-commerce platforms built for scale, performance, and exceptional user experience.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border border-light-grey">
              <h3 className="text-2xl font-bold text-navy-blue mb-4">Mobile Applications</h3>
              <p className="text-charcoal mb-6">
                Native and cross-platform mobile apps that provide seamless shopping experiences.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start text-charcoal">
                  <i className="fas fa-star text-warm-orange mr-3 mt-1"></i>
                ...
                <li className="flex items-start text-charcoal">
                  <i className="fas fa-star text-warm-orange mr-3 mt-1"></i>
                  <span>Mobile Commerce Features</span>
                </li>
              </ul>
            </div>

            <div className="bg-white rounded-lg shadow-lg p-8 border border-light-grey">
              <h3 className="text-2xl font-bold text-navy-blue mb-4">Personalization Engines</h3>
              <p className="text-charcoal mb-6">
                AI-powered personalization to deliver tailored experiences and increase conversions.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start text-charcoal">
                  <i className="fas fa-star text-warm-orange mr-3 mt-1"></i>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border border-light-grey">
              <h3 className="text-2xl font-bold text-navy-blue mb-4">Conversion Optimization</h3>
              <p className="text-charcoal mb-6">
                Data-driven optimization strategies to maximize conversion rates and revenue.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start text-charcoal">
                  <i className="fas fa-star text-warm-orange mr-3 mt-1"></i>
                  <span>A/B Testing Frameworks</span>
                </li>
                <li className="flex items-start text-charcoal">
                  <i className="fas fa-star text-warm-orange mr-3 mt-1"></i>
      ...
      <section className="py-20 bg-soft-beige">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-charcoal max-w-3xl mx-auto">
              How we helped a US flooring firm go paperless and improve business efficiency.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h3 className="text-2xl font-bold text-navy-blue mb-6">
                  US Flooring Firm Digital Transformation
                </h3>
                <p className="text-charcoal mb-6">
                  A leading flooring company needed to modernize their operations by going paperless and improving customer interactions through digital solutions.
                </p>
              ...
              <div className="flex flex-col justify-center">
                <div className="text-center p-8 bg-soft-beige rounded-lg">
                  ...
                  <div className="text-charcoal">Paperless operations achieved</div>
                </div>
                <div className="mt-6 text-center">
                  <p className="text-sm text-charcoal italic">
                    "The digital transformation streamlined our entire business process."
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-navy-blue mb-4">
              Why Choose Asterik for Retail & E-commerce
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal">
                Deep understanding of e-commerce platforms and retail technology.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-navy-blue rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-charcoal">
                Mobile-optimized solutions for the modern shopping experience.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-navy-blue rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-charcoal">
                Analytics and optimization focused on measurable business outcomes.
              </p>
            </div>
          </div>
        </div>
