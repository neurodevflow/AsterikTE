      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="bg-soft-beige rounded-lg p-6 text-center">
              <h3 className="text-lg font-bold text-navy-blue mb-4">Quality Systems</h3>
              <ul className="text-charcoal space-y-2">
                <li>• ISO 14155</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-charcoal">
                Comprehensive evaluation of current healthcare systems and workflows
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal">
                Custom solution design aligned with healthcare standards and regulations
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-charcoal">
                Phased implementation with minimal disruption to patient care
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-navy-blue mb-4">Training & Support</h3>
              <p className="text-charcoal">
                Comprehensive training and ongoing support for healthcare professionals
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-navy-blue">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white mb-8 max-w-3xl mx-auto">
            Improve patient outcomes and operational efficiency with our comprehensive healthcare technology solutions.
          </p>
